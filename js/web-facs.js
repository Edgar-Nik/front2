...
if(document.querySelector('#mobile-show-btn')){
  document.querySelector('#mobile-show-btn').addEventListener('click',()=>{
    document.querySelector('.side-nav').classList.toggle('active-slide-nav')
  })
}
