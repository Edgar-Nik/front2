...
document.querySelector('.slider-btn').addEventListener('click', () => {
  document.querySelector('#navbar').classList.toggle('closed-navbar');
  document.querySelector('.slider-btn').classList.toggle('rotate-btn');
});

const userNavClose = document.querySelector('.user-nav-close-btn');
const userNavOpen = document.querySelector('.mobile-user-nav-open');

if (userNavOpen) {
  userNavOpen.addEventListener('click', () => {
    document.querySelector('.user-nav').classList.add('mobile-user-nav-active');
    userNavOpen.classList.add('mobile-user-nav-hide');
  });
}
if (userNavClose) {
  userNavClose.addEventListener('click', () => {
    document.querySelector('.user-nav').classList.remove('mobile-user-nav-active');
    userNavOpen.classList.remove('mobile-user-nav-hide');
  });
}
...
themeBtnRound.addEventListener('click', () => {
  document.querySelector('#navbar').classList.toggle('active-dark-mode-1');
  document.querySelector('.slider-btn').classList.toggle('active-dark-mode-1');
  document.querySelector('.header-nav').classList.toggle('active-dark-mode-1');
  document.querySelector('.user-nav').classList.toggle('active-dark-mode-1');
  document.querySelector('.lesson-plan').classList.toggle('active-dark-mode-1');
  document.querySelector('.homework').classList.toggle('active-dark-mode-1');
  document.querySelector('.bar-chart').classList.toggle('active-dark-mode-1');
  ...
  document.querySelector('.chart-wrapper').classList.toggle('active-dark-mode-1');
  ...
  document.querySelectorAll('.lessons-info').forEach((item) => {
    item.classList.toggle('active-dark-mode-1');
  });

  document.body.classList.toggle('active-dark-mode-2');
...
if (mobileDarkBtn) {
  mobileDarkBtn.addEventListener('click', () => {
    ...
    document.querySelector('.mobile-user-nav-open').classList.toggle('active-dark-mode-1');
    document
