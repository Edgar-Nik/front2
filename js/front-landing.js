if (document.querySelector('#level-slider-btn')) {
  document.querySelector('#level-slider-btn').addEventListener('click', () => {
    document.querySelector('.level-content-items').style.height = 'auto';
    document.querySelector('#level-slider-close-btn').style.display = 'flex';
    document.querySelector('#level-slider-btn').style.display = 'none';
  });
}

if (document.querySelector('#level-slider-close-btn')) {
  document.querySelector('#level-slider-close-btn').addEventListener('click', () => {
    if(document.body.clientWidth<=500){
      document.querySelector('.level-content-items').style.height = '125rem';

    }else{
      document.querySelector('.level-content-items').style.height = '36rem';
    }
    
    document.querySelector('#level-slider-close-btn').style.display = 'none';
    document.querySelector('#level-slider-btn').style.display = 'flex';
  });
}
...
document.querySelector('.sertificate-container').classList.toggle('body-dark-active')
...
if (mobileDarkBtn) {
  mobileDarkBtn.addEventListener('click', () => {
    ...
    document.body.classList.toggle('body-dark-active')
    document.querySelector('.sertificate-container').classList.toggle('body-dark-active')
    document.querySelector('.mobile-menu-slider-active').classList.toggle('mobile-menu-slider-dark');
