...
themeBtnRound.addEventListener('click', () => {
 ...
 document.querySelector('.txt2').classList.toggle('page-text-dark-active');
 document.querySelectorAll('.free').forEach(item=>item.classList.toggle('page-container-dark-active'))
 document.querySelectorAll('.txt3').forEach(item=>item.classList.toggle('page-text-dark-active'))
 document.querySelectorAll('.txt4').forEach(item=>item.classList.toggle('page-text-dark-active'))
