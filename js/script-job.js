...
if(document.querySelector(".check")){
    document.querySelector(".check").addEventListener('click',()=>{
        if(document.querySelector(".check").checked){
            document.querySelector(".txt18").style.display="block";
            document.querySelector(".txt19").style.display="block";
        }
        else{
            document.querySelector(".txt18").style.display="none";
            document.querySelector(".txt19").style.display="none";
...
if(document.querySelector("#continue")){
    document.querySelector("#continue").addEventListener('click',()=>{
        ...
        document.querySelector(".button_active").classList.add("btn2");
        document.querySelector(".button_active").classList.remove("button_active");
        document.querySelector("#btn2").classList.add("button_active");
    ...
    document.querySelector("#previous").addEventListener('click',()=>{
        ...
        document.querySelector("#btn2").classList.remove("button_active");
        document.querySelector("#btn1").classList.add("button_active");
        document.body.scrollTop = 0;
        document.documentElement.scrollTop = 0;
    ...
    document.querySelector("#continue1").addEventListener('click',()=>{
        ...
        document.querySelector("#btn2").classList.remove("button_active");
        document.querySelector("#btn3").classList.add("button_active");
        document.body.scrollTop = 0;
        document.documentElement.scrollTop = 0;
    ...
    document.querySelector("#previous1").addEventListener('click',()=>{
        document.querySelector("#btn2").classList.add("button_active");
        document.querySelector("#btn3").classList.remove("button_active");
    ...
    document.querySelector("#previous2").addEventListener('click',()=>{
        document.querySelector("#btn4").classList.remove("button_active");
        document.querySelector("#btn3").classList.add("button_active");
    ...
    document.querySelector("#continue2").addEventListener('click',()=>{
        ...
        document.querySelector("#btn3").classList.remove("button_active");
        document.querySelector("#btn4").classList.add("button_active");
        document.body.scrollTop = 0;
        document.documentElement.scrollTop = 0;
    
    });
    
    document.querySelector("#previous3").addEventListener('click',()=>{
        document.querySelector("#btn5").classList.remove("button_active");
        document.querySelector("#btn4").classList.add("button_active");
    ...
    document.querySelector("#continue3").addEventListener('click',()=>{
        ...
        document.querySelector("#btn4").classList.remove("button_active");
        document.querySelector("#btn5").classList.add("button_active");
        document.body.scrollTop = 0;
        document.documentElement.scrollTop = 0;
    });
...
const datepicker1 = new TheDatepicker.Datepicker(date1);
datepicker1.render();
const date2 = document.getElementById('date2');
const datepicker2 = new TheDatepicker.Datepicker(date2);
datepicker2.render();
const date3 = document.getElementById('date3');
const datepicker3 = new TheDatepicker.Datepicker(date3);
datepicker3.render();
const date4 = document.getElementById('date4');
const datepicker4 = new TheDatepicker.Datepicker(date4);
datepicker4.render();
const date5 = document.getElementById('date5');
const datepicker5 = new TheDatepicker.Datepicker(date5);
datepicker5.render();


$('#phone-home').intlTelInput({
  allowDropdown: true,
  excludeCountries: ['az', 'tr'],
  preferredCountries: ['am', 'ru'],
  separateDialCode: true,
});
$('#phone-cell').intlTelInput({
  allowDropdown: true,
  excludeCountries: ['az', 'tr'],
  preferredCountries: ['am', 'ru'],
  separateDialCode: true,
